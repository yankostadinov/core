(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Decoder$1 = /** @class */ (function () {
         ...
         */
        Decoder.optional = function (decoder) {
            return new Decoder(function (json) { return (json === undefined ? ok$1(undefined) : decoder.decode(json)); });
        };
        /**
         * Decoder that attempts to run each decoder in `decoders` and either succeeds
         * with the first successful decoder, or fails after all decoders have failed.
    ...
    const workspaceBuilderCreateConfigDecoder = optional$1(object$1({
        saveLayout: optional$1(boolean())
    }));
    ...
    const parentDefinitionDecoder = optional$1(object$1({
        type: optional$1(subParentDecoder),
        children: optional$1(lazy(() => array$1(oneOf$1(swimlaneWindowDefinitionDecoder, parentDefinitionDecoder))))
    }));
    ...
    const restoreWorkspaceConfigDecoder = optional$1(object$1({
        ...
        lockdown: optional$1(boolean()),
        activateFrame: optional$1(boolean()),
        newFrame: optional$1(oneOf$1(newFrameConfigDecoder, boolean())),
    ...
    const workspaceDefinitionDecoder = object$1({
        ...
        config: optional$1(object$1({
            title: optional$1(nonEmptyStringDecoder$1),
            position: optional$1(nonNegativeNumberDecoder),
            isFocused: optional$1(boolean())
        })),
        frame: optional$1(object$1({
            reuseFrameId: optional$1(nonEmptyStringDecoder$1),
            newFrame: optional$1(oneOf$1(boolean(), newFrameConfigDecoder))
        }))
    });
    const builderConfigDecoder = object$1({
        type: allParentDecoder,
        definition: oneOf$1(workspaceDefinitionDecoder, parentDefinitionDecoder)
    });
    ...
    const swimlaneWindowSummaryDecoder = object$1({
    ...
    const streamRequestArgumentsDecoder = object$1({
        type: oneOf$1(constant$1("frame"), constant$1("workspace"), constant$1("container"), constant$1("window")),
        branch: nonEmptyStringDecoder$1
    });
    const streamActionDecoder = oneOf$1(constant$1("opened"), constant$1("closing"), constant$1("closed"), constant$1("focus"), constant$1("added"), constant$1("loaded"), constant$1("removed"), constant$1("childrenUpdate"), constant$1("containerChange"));
    ...
    const childSnapshotResultDecoder = object$1({
        ...
        children: optional$1(lazy(() => array$1(childSnapshotResultDecoder))),
    ...
    const customWorkspaceChildSnapshotDecoder = object$1({
        id: optional$1(nonEmptyStringDecoder$1),
        config: oneOf$1(parentSnapshotConfigDecoder, swimlaneWindowSnapshotConfigDecoder),
        children: optional$1(lazy(() => array$1(customWorkspaceChildSnapshotDecoder))),
        type: oneOf$1(constant$1("window"), constant$1("row"), constant$1("column"), constant$1("group"))
    });
    const customWorkspaceSnapshotDecoder = object$1({
        id: optional$1(nonEmptyStringDecoder$1),
        children: array$1(customWorkspaceChildSnapshotDecoder),
    });
    const swimlaneLayoutDecoder = object$1({
        name: nonEmptyStringDecoder$1,
        layout: optional$1(customWorkspaceSnapshotDecoder),
        workspaceId: optional$1(nonEmptyStringDecoder$1)
    });
    const exportedLayoutsResultDecoder = object$1({
        layouts: array$1(swimlaneLayoutDecoder)
    });
    ...
    class Workspace {
        ...
        saveLayout(name) {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                yield getData(this).controller.importLayout({ name, workspaceId: this.id });
            });
        }
        setTitle(title) {
            return __awaiter$1(this, void 0, void 0, function* () {
                nonEmptyStringDecoder$1.runWithException(title);
                const controller = getData(this).controller;
        ...
        onClosing(callback) {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                const wrappedCallback = () => __awaiter$1(this, void 0, void 0, function* () {
                    yield this.refreshReference();
                    callback();
                });
                const config = {
        ...
        onWindowAdded(callback) {
            return __awaiter$1(this, void 0, void 0, function* () {
                checkThrowCallback(callback);
                const id = getData(this).id;
                const wrappedCallback = (payload) => __awaiter$1(this, void 0, void 0, function* () {
                    yield this.refreshReference();
    ...
    class Column {
        ...
        get frameId() {
            return getBase$1(this).frameId;
        }
        get workspaceId() {
            return getBase$1(this).workspaceId;
        }
        get positionIndex() {
            return getBase$1(this).positionIndex;
        }
        getChild(predicate) {
    ...
    class Group {
        ...
        get frameId() {
            return getBase$2(this).frameId;
        }
        get workspaceId() {
            return getBase$2(this).workspaceId;
        }
        get positionIndex() {
            return getBase$2(this).positionIndex;
        }
        getChild(predicate) {
    ...
    class EnterpriseController {
        constructor(bridge, windows, ioc, privateDataManager) {
            this.bridge = bridge;
            this.windows = windows;
            this.ioc = ioc;
        ...
        getFrame(selector) {
            return __awaiter$1(this, void 0, void 0, function* () {
                if (selector.windowId) {
                    const frameSummary = yield this.bridge.send(OPERATIONS.getFrameSummary.name, { itemId: selector.windowId });
                    const frameConfig = {
                        summary: frameSummary
                    };
        ...
        getFrames(predicate) {
            return __awaiter$1(this, void 0, void 0, function* () {
                const allFrameSummaries = yield this.bridge.send(OPERATIONS.getAllFramesSummaries.name);
                return allFrameSummaries.summaries.reduce((frames, frameSummary) => {
                    const frameConfig = {
                        summary: frameSummary
                    };
        ...
        getAllWorkspaceSummaries() {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                return allSummariesResult.summaries.map((summary) => {
                    return {
                        id: summary.id,
        ...
        ejectWindow(itemId) {
            return __awaiter$1(this, void 0, void 0, function* () {
                yield this.bridge.send(OPERATIONS.ejectWindow.name, { itemId });
            });
        }
        ...
        iterateWorkspaces(callback) {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                const workspaceIds = (yield this.getAllWorkspaceSummaries()).map((summary) => summary.id);
                for (const workspaceId of workspaceIds) {
                    ...
                    const frame = this.ioc.getModel("frame", frameConfig);
                    const workspaceConfig = { frame, snapshot };
                    const wsp = this.ioc.getModel("workspace", workspaceConfig);
                    callback(wsp, end);
                }
            });
        }
    ...
    class ParentBuilder {
        constructor(definition, base) {
            ...
            privateData$3.set(this, { base, children, definition });
        }
        get type() {
            return privateData$3.get(this).definition.type;
        }
        addColumn(definition) {
            const base = privateData$3.get(this).base;
            return base.add("column", privateData$3.get(this).children, definition);
        }
        addRow(definition) {
            const base = privateData$3.get(this).base;
            return base.add("row", privateData$3.get(this).children, definition);
        }
        addGroup(definition) {
            const base = privateData$3.get(this).base;
            return base.add("group", privateData$3.get(this).children, definition);
        }
        addWindow(definition) {
            const base = privateData$3.get(this).base;
            base.addWindow(privateData$3.get(this).children, definition);
            return this;
        }
        serialize() {
    ...
    class WorkspaceBuilder {
        constructor(definition, base, controller) {
            const children = base.wrapChildren(definition.children);
            delete definition.children;
            privateData$4.set(this, { base, children, definition, controller });
        }
        addColumn(definition) {
            const children = privateData$4.get(this).children;
        ...
        getChildAt(index) {
            ...
            const data = privateData$4.get(this).children;
            return data[index];
        }
        create(config) {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                const controller = privateData$4.get(this).controller;
    ...
    class Frame {
        ...
        restore() {
            ...
            return getData$2(this).controller.restoreItem(myId);
        }
        maximize() {
            const myId = getData$2(this).summary.id;
            return getData$2(this).controller.maximizeItem(myId);
        }
        resize(config) {
    ...
    class CoreController {
        constructor(bridge, windows, ioc, privateDataManager, frameUtils, layouts) {
            this.bridge = bridge;
            this.windows = windows;
            this.ioc = ioc;
            this.privateDataManager = privateDataManager;
        ...
        getFrame(selector) {
            return __awaiter$1(this, void 0, void 0, function* () {
                if (selector.windowId) {
                    ...
                    const frameSummary = yield this.bridge.send(OPERATIONS.getFrameSummary.name, { itemId: selector.windowId }, frameInstance);
                    const frameConfig = {
                        summary: frameSummary
                    };
                    return this.ioc.getModel("frame", frameConfig);
        ...
        getAllWorkspaceSummaries() {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                const allSummaries = allResults.reduce((summaries, summaryResult) => {
        ...
        iterateWorkspaces(callback) {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                for (const summary of workspaceSummaries) {
                    ...
                    const snapshot = yield this.bridge.send(OPERATIONS.getWorkspaceSnapshot.name, { itemId: summary.id }, frameInstance);
                    const frameSummary = yield this.bridge.send(OPERATIONS.getFrameSummary.name, { itemId: snapshot.config.frameId }, frameInstance);
                    const frameConfig = {
                        summary: frameSummary
                    };
    ...
    class CoreFrameUtils {
        constructor(interop, windows, bridge) {
            ...
            this.windows = windows;
            this.bridge = bridge;
            this.workspacesRoute = "/glue/workspaces/index.html";
        ...
        openNewWorkspacesFrame(newFrameConfig) {
            return new Promise((resolve, reject) => {
                ...
                const unsubscribe = this.interop.serverAdded((server) => {
                    if ((frameWindow === null || frameWindow === void 0 ? void 0 : frameWindow.id) && frameWindow.id === server.windowId) {
                        unsubscribe();
                        resolve(server);
                    }
                });
    ...
    class IoC {
        ...
        get bridge() {
            if (!this._bridgeInstance) {
                this._bridgeInstance = new Bridge(this.transport, lib$2());
            }
    ...
    var WorkspacesFactory = (agm, windows, layoutsAPI, ioc) => {
        ...
        const getMyFrame = () => __awaiter$1(void 0, void 0, void 0, function* () {
        ...
        const getFrame = (predicate) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(predicate);
            return controller.getFrame({ predicate });
        });
        const getAllFrames = (predicate) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(predicate, true);
        ...
        const getMyWorkspace = () => __awaiter$1(void 0, void 0, void 0, function* () {
            const myId = windows.my().id;
            if (!myId) {
        ...
        const getWorkspace = (predicate) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(predicate);
        ...
        const getWindow = (predicate) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(predicate);
            return controller.getWindow(predicate);
        });
        const getParent = (predicate) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(predicate);
            return controller.getParent(predicate);
        });
        const restoreWorkspace = (name, options) => __awaiter$1(void 0, void 0, void 0, function* () {
            nonEmptyStringDecoder$1.runWithException(name);
            const validatedOptions = restoreWorkspaceConfigDecoder.runWithException(options);
            return controller.restoreWorkspace(name, validatedOptions);
        });
        const createWorkspace = (definition, saveConfig) => __awaiter$1(void 0, void 0, void 0, function* () {
            const validatedDefinition = workspaceDefinitionDecoder.runWithException(definition);
        ...
        const layouts = {
            ...
            delete: (name) => __awaiter$1(void 0, void 0, void 0, function* () {
                nonEmptyStringDecoder$1.runWithException(name);
                return controller.deleteLayout(name);
            }),
            export: (predicate) => __awaiter$1(void 0, void 0, void 0, function* () {
                checkThrowCallback(predicate, true);
                return controller.exportLayout(predicate);
            }),
            import: (layout) => __awaiter$1(void 0, void 0, void 0, function* () {
                swimlaneLayoutDecoder.runWithException(layout);
                console.log("passed first decoder");
                return controller.importLayout(layout);
            })
        };
        const onFrameOpened = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => {
                const frameConfig = {
        ...
        const onFrameClosing = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => {
                const frameConfig = {
                    summary: payload.frameSummary
        ...
        const onFrameClosed = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => {
                callback({ frameId: payload.frameSummary.id });
            };
        ...
        const onFrameFocusChange = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => {
                const frameConfig = {
                    summary: payload.frameSummary
        ...
        const onWorkspaceOpened = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            console.log("test 123");
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => __awaiter$1(void 0, void 0, void 0, function* () {
                const frameConfig = {
                    summary: payload.frameSummary
                };
                const frame = ioc.getModel("frame", frameConfig);
        ...
        const onWorkspaceClosing = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => __awaiter$1(void 0, void 0, void 0, function* () {
                const frameConfig = {
                    summary: payload.frameSummary
        ...
        const onWorkspaceClosed = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => {
                callback({ frameId: payload.frameSummary.id, workspaceId: payload.workspaceSummary.id });
            };
        ...
        const onWorkspaceFocusChange = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => __awaiter$1(void 0, void 0, void 0, function* () {
                const frameConfig = {
                    summary: payload.frameSummary
        ...
        const onWindowAdded = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => __awaiter$1(void 0, void 0, void 0, function* () {
        ...
        const onWindowLoaded = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => __awaiter$1(void 0, void 0, void 0, function* () {
                const snapshot = (yield controller.getSnapshot(payload.windowSummary.config.workspaceId, "workspace"));
                const frameConfig = {
        ...
        const onWindowRemoved = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => {
                const { windowId, workspaceId, frameId } = payload.windowSummary.config;
                callback({ windowId, workspaceId, frameId });
        ...
        const onWindowFocusChange = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => __awaiter$1(void 0, void 0, void 0, function* () {
                const snapshot = (yield controller.getSnapshot(payload.windowSummary.config.workspaceId, "workspace"));
                const frameConfig = {
        ...
        const onParentAdded = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => __awaiter$1(void 0, void 0, void 0, function* () {
        ...
        const onParentRemoved = (callback) => __awaiter$1(void 0, void 0, void 0, function* () {
            checkThrowCallback(callback);
            const wrappedCallback = (payload) => {
                const { workspaceId, frameId } = payload.containerSummary.config;
                callback({ id: payload.containerSummary.itemId, workspaceId, frameId });
