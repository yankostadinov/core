...
export default function rateMetric(definition: Glue42Core.Metrics.MetricDefinition, parent: Glue42Core.Metrics.System, transport: Protocol, value: any): Glue42Core.Metrics.RateMetric {
    ...
    const type: number = MetricTypes.RATE;
    ...
    const me: Glue42Core.Metrics.RateMetric = {
        name,
        description,
        period,
        resolution,
