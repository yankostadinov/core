...
export default function timestampMetric(definition: Glue42Core.Metrics.MetricDefinition, parent: Glue42Core.Metrics.System, transport: Protocol, value: any): Glue42Core.Metrics.TimestampMetric {
    ...
    const type: number = MetricTypes.TIMESTAMP;
    ...
    const me: Glue42Core.Metrics.TimestampMetric = {
        name,
        description,
        period,
        resolution,
